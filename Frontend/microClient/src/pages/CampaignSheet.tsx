    ...
    const handleSendMessage = async () => {
        ...
        try {
            const newMessageObj: Message = {
                id: "", // The ID would be generated by the backend
                campaignId: campaignId || "",
                characterId: "", // Assume characterId is optional or set elsewhere
                message: newMessage
            };
            // NEED TO FIX THIS PART

            const response = await fetch(`http://localhost:8081/dice/message`, {
                method: 'POST',
                headers: {
            ...
            setChatMessages(prevMessages => [...prevMessages, { ...newMessageObj, id: `${Date.now()}` }]);
            setNewMessage("");
        } catch (err) {
